namespace JSZW1000A
{
    partial class DialogAsk
    {
        ...
        private void InitializeComponent()
        {
            ...
            label1.Font = new Font("微软雅黑", 18F, FontStyle.Regular, GraphicsUnit.Point);
            label1.ForeColor = Color.WhiteSmoke;
            label1.Location = new Point(147, 62);
            label1.Name = "label1";
            label1.Size = new Size(574, 52);
            label1.TabIndex = 36;
            label1.Text = "询问内容";
            ...
            btn确定.Font = new Font("宋体", 11.25F, FontStyle.Regular, GraphicsUnit.Point);
            btn确定.ForeColor = Color.White;
            btn确定.Image = Properties.Resources.tick1;
            btn确定.Location = new Point(241, 218);
            btn确定.Name = "btn确定";
            ...
            btn确定.UseVisualStyleBackColor = true;
