namespace JSZW1000A
{
    public partial class FrmForceMan : Form
    {
        ...
        public void setLang()
        {
            ...
            btn上翻板缩回.Text = (MainFrm.Lang == 0) ? "  上滑台\r\n  缩回" : "   Top Apron\r\n   Retract";
            btn上翻板伸出.Text = (MainFrm.Lang == 0) ? "  上滑台\r\n  伸出" : "   Top Apron\r\n   Stretch";
            btn上翻板归零.Text = (MainFrm.Lang == 0) ? "  上翻板\r\n  归零" : "   Top Apron\r\n   ToZero";
            btn上翻板折弯.Text = (MainFrm.Lang == 0) ? "  上翻板\r\n  折弯" : "   Top Apron\r\n   ToFold";
            btn下翻板缩回.Text = (MainFrm.Lang == 0) ? "  下滑台\r\n  缩回" : "  Bottom Apron\r\n Retract";
            btn下翻板伸出.Text = (MainFrm.Lang == 0) ? "  下滑台\r\n  伸出" : "  Bottom Apron\r\n Stretch";
            btn下翻板归零.Text = (MainFrm.Lang == 0) ? "  下翻板\r\n  归零" : "  Bottom Apron\r\n ToZero";
            btn下翻板折弯.Text = (MainFrm.Lang == 0) ? "  下翻板\r\n  折弯" : "  Bottom Apron\r\n ToFold";
