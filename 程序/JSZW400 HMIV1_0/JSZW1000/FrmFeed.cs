...
namespace JSZW400
{
    public partial class FrmFeed : Form
    {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            sw吸盘1.BackgroundImage = MainFrm.Hmi_bArray[55] ? global::JSZW400.Properties.Resources.sw_左右小开关1 : global::JSZW400.Properties.Resources.sw_左右小开关0;
            sw吸盘2.BackgroundImage = MainFrm.Hmi_bArray[56] ? global::JSZW400.Properties.Resources.sw_左右小开关1 : global::JSZW400.Properties.Resources.sw_左右小开关0;
        }
        ...
        private void btn确认_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                foreach (DataGridViewRow row in dataGridView1.Rows)
                {
                    ...
                    {
                        Index = Convert.ToInt32(row.Cells["Index"].Value),
                        Width = Convert.ToInt32(row.Cells["Width"].Value),
                        Length = Convert.ToInt32(row.Cells["Length"].Value),
                        Quantity = Convert.ToInt32(row.Cells["Quantity"].Value),
                        Groups = Convert.ToInt32(row.Cells["GroupsNeeded"].Value)
                    };
                    // 校验长度
