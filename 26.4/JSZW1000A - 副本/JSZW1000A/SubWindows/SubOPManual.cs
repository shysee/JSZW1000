...
namespace JSZW1000A.SubWindows
{
    public partial class SubOPManual : UserControl
    {
        ...
        public void setLang()
        {
            ...
            label9.Text = label4.Text = label6.Text = label7.Text = label8.Text = label3.Text = label2.Text = lb底部翻板val2.Text = (MainFrm.Lang == 0) ? "毫米" : "mm";
            ...
            button9.Text = (MainFrm.Lang == 0) ? "下载半自动\r\n到PLC" : "Download\r\n to PLC";
        ...
        */
        ...
        private void timer500ms_Tick(object sender, EventArgs e)
        {
            ...
            txb底部翻板val2.Text = MainFrm.Hmi_rArray[39].ToString("f1");
