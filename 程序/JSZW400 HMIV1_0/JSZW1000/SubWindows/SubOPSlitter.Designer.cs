namespace JSZW400.SubWindows
{
    partial class SubOPSlitter
    {
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(SubOPSlitter));
            ...
            lb边角料长度_后.Size = new Size(81, 19);
            lb边角料长度_后.TabIndex = 30;
            lb边角料长度_后.Text = "1203.0 mm";
            // 
            // label3
            // 
            ...
            lb边角料长度_先.Size = new Size(81, 19);
            lb边角料长度_先.TabIndex = 30;
            lb边角料长度_先.Text = "1203.0 mm";
            // 
            // label6
            // 
            ...
            // btn拉刀后退
            // 
            btn拉刀后退.BackgroundImage = Properties.Resources.bg_大按钮1;
            btn拉刀后退.FlatAppearance.BorderSize = 0;
            btn拉刀后退.FlatStyle = FlatStyle.Flat;
            btn拉刀后退.Font = new Font("宋体", 11.25F, FontStyle.Regular, GraphicsUnit.Point);
            btn拉刀后退.ForeColor = Color.White;
            btn拉刀后退.Image = (Image)resources.GetObject("btn拉刀后退.Image");
            btn拉刀后退.Location = new Point(1165, 244);
            btn拉刀后退.Name = "btn拉刀后退";
            btn拉刀后退.Size = new Size(161, 55);
            btn拉刀后退.TabIndex = 48;
            btn拉刀后退.Text = "    后退  ";
            btn拉刀后退.TextAlign = ContentAlignment.MiddleRight;
            btn拉刀后退.TextImageRelation = TextImageRelation.ImageBeforeText;
            btn拉刀后退.UseVisualStyleBackColor = true;
            btn拉刀后退.MouseDown += btn拉刀后退_MouseDown;
            btn拉刀后退.MouseUp += btn拉刀后退_MouseUp;
            // 
            // btn拉刀前进
            // 
            btn拉刀前进.BackgroundImage = Properties.Resources.bg_大按钮1;
            btn拉刀前进.FlatAppearance.BorderSize = 0;
            btn拉刀前进.FlatStyle = FlatStyle.Flat;
            btn拉刀前进.Font = new Font("宋体", 11.25F, FontStyle.Regular, GraphicsUnit.Point);
            btn拉刀前进.ForeColor = Color.White;
            btn拉刀前进.Image = (Image)resources.GetObject("btn拉刀前进.Image");
            btn拉刀前进.Location = new Point(1165, 181);
            btn拉刀前进.Name = "btn拉刀前进";
            btn拉刀前进.Size = new Size(161, 55);
            btn拉刀前进.TabIndex = 47;
            btn拉刀前进.Text = "    前进  ";
            btn拉刀前进.TextAlign = ContentAlignment.MiddleRight;
            btn拉刀前进.TextImageRelation = TextImageRelation.ImageBeforeText;
            btn拉刀前进.UseVisualStyleBackColor = true;
            btn拉刀前进.MouseDown += btn拉刀前进_MouseDown;
            btn拉刀前进.MouseUp += btn拉刀前进_MouseUp;
            // 
            // SubOPSlitter
            // 
            AutoScaleMode = AutoScaleMode.None;
            BackgroundImage = Properties.Resources.bg_Slitter_main;
            Controls.Add(btn拉刀后退);
            Controls.Add(btn拉刀前进);
        ...
        private Button btn拉刀后退;
        private Button btn拉刀前进;
    }
}
