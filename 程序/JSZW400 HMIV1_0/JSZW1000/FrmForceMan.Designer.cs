namespace JSZW400
{
    partial class FrmForceMan
    {
        ...
        private void InitializeComponent()
        {
            ...
            // btn上滑台伸出
            // 
            btn上滑台伸出.BackgroundImage = Properties.Resources.bg_大按钮150;
            btn上滑台伸出.BackgroundImageLayout = ImageLayout.Stretch;
            btn上滑台伸出.FlatAppearance.BorderSize = 0;
            btn上滑台伸出.FlatStyle = FlatStyle.Flat;
            btn上滑台伸出.Font = new Font("微软雅黑", 13.25F, FontStyle.Regular, GraphicsUnit.Point);
            btn上滑台伸出.ForeColor = Color.White;
            btn上滑台伸出.Image = (Image)resources.GetObject("btn上滑台伸出.Image");
            btn上滑台伸出.Location = new Point(509, 143);
            btn上滑台伸出.Name = "btn上滑台伸出";
            btn上滑台伸出.Size = new Size(150, 110);
            btn上滑台伸出.TabIndex = 42;
            btn上滑台伸出.Text = "  上滑台   伸出";
            btn上滑台伸出.TextImageRelation = TextImageRelation.ImageBeforeText;
            btn上滑台伸出.UseVisualStyleBackColor = true;
            btn上滑台伸出.MouseDown += btn上翻板归零_MouseDown;
            btn上滑台伸出.MouseUp += btn上翻板归零_MouseUp;
            // 
            // btn上滑台缩回
            // 
            btn上滑台缩回.BackgroundImage = Properties.Resources.bg_大按钮150;
            btn上滑台缩回.BackgroundImageLayout = ImageLayout.Stretch;
            btn上滑台缩回.FlatAppearance.BorderSize = 0;
            btn上滑台缩回.FlatStyle = FlatStyle.Flat;
            btn上滑台缩回.Font = new Font("微软雅黑", 13.25F, FontStyle.Regular, GraphicsUnit.Point);
            btn上滑台缩回.ForeColor = Color.White;
            btn上滑台缩回.Image = (Image)resources.GetObject("btn上滑台缩回.Image");
            btn上滑台缩回.Location = new Point(393, 12);
            btn上滑台缩回.Name = "btn上滑台缩回";
            btn上滑台缩回.Size = new Size(150, 110);
            btn上滑台缩回.TabIndex = 43;
            btn上滑台缩回.Text = "  上滑台\r\n  缩回";
            btn上滑台缩回.TextImageRelation = TextImageRelation.ImageBeforeText;
            btn上滑台缩回.UseVisualStyleBackColor = true;
            btn上滑台缩回.MouseDown += btn上翻板归零_MouseDown;
            btn上滑台缩回.MouseUp += btn上翻板归零_MouseUp;
            // 
            // btn下滑台缩回
            // 
            btn下滑台缩回.BackgroundImage = Properties.Resources.bg_大按钮150;
            btn下滑台缩回.BackgroundImageLayout = ImageLayout.Stretch;
            btn下滑台缩回.FlatAppearance.BorderSize = 0;
            btn下滑台缩回.FlatStyle = FlatStyle.Flat;
            btn下滑台缩回.Font = new Font("微软雅黑", 13.25F, FontStyle.Regular, GraphicsUnit.Point);
            btn下滑台缩回.ForeColor = Color.White;
            btn下滑台缩回.Image = Properties.Resources.BotApronSlide_Dn1;
            btn下滑台缩回.Location = new Point(393, 438);
            btn下滑台缩回.Name = "btn下滑台缩回";
            btn下滑台缩回.Size = new Size(150, 110);
            btn下滑台缩回.TabIndex = 45;
            btn下滑台缩回.Text = "  下滑台\r\n  缩回";
            btn下滑台缩回.TextImageRelation = TextImageRelation.ImageBeforeText;
            btn下滑台缩回.UseVisualStyleBackColor = true;
            btn下滑台缩回.MouseDown += btn上翻板归零_MouseDown;
            btn下滑台缩回.MouseUp += btn上翻板归零_MouseUp;
            // 
            // btn下滑台伸出
            // 
            btn下滑台伸出.BackgroundImage = Properties.Resources.bg_大按钮150;
            btn下滑台伸出.BackgroundImageLayout = ImageLayout.Stretch;
            btn下滑台伸出.FlatAppearance.BorderSize = 0;
            btn下滑台伸出.FlatStyle = FlatStyle.Flat;
            btn下滑台伸出.Font = new Font("微软雅黑", 13.25F, FontStyle.Regular, GraphicsUnit.Point);
            btn下滑台伸出.ForeColor = Color.White;
            btn下滑台伸出.Image = Properties.Resources.BotApronSlide_Up1;
            btn下滑台伸出.Location = new Point(509, 303);
            btn下滑台伸出.Name = "btn下滑台伸出";
            btn下滑台伸出.Size = new Size(150, 110);
            btn下滑台伸出.TabIndex = 44;
            btn下滑台伸出.Text = "  下滑台\r\n  伸出";
            btn下滑台伸出.TextImageRelation = TextImageRelation.ImageBeforeText;
            btn下滑台伸出.UseVisualStyleBackColor = true;
            btn下滑台伸出.MouseDown += btn上翻板归零_MouseDown;
            btn下滑台伸出.MouseUp += btn上翻板归零_MouseUp;
            // 
            // btn上翻板折弯
            // 
            ...
            Controls.Add(btn下滑台缩回);
            Controls.Add(btn下滑台伸出);
            Controls.Add(btn上滑台缩回);
            Controls.Add(btn上滑台伸出);
        ...
        private Button btn上滑台伸出;
        private Button btn上滑台缩回;
        private Button btn下滑台缩回;
        private Button btn下滑台伸出;
