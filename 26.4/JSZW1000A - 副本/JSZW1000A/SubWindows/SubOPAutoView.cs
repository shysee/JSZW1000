...
namespace JSZW1000A.SubWindows
{
    ...
    public partial class SubOPAutoView : UserControl
    {
        ...
        private void 内外选择显示()
        {
            if ((int)db内外选择子项 == 0)
            {
                btn内外选择.Image = global::JSZW1000A.Properties.Resources.btm_单工双工0;
            ...
            {
                btn内外选择.Image = global::JSZW1000A.Properties.Resources.btm_单工双工1;
        ...
        {
            if ((int)db抓取类型子项 == 0)
                btn抓取类型.Image = global::JSZW1000A.Properties.Resources.btm_3档开关彩1;
            else if ((int)db抓取类型子项 == 1)
                btn抓取类型.Image = global::JSZW1000A.Properties.Resources.btm_3档开关彩2;
            else if ((int)db抓取类型子项 == 2)
                btn抓取类型.Image = global::JSZW1000A.Properties.Resources.btm_3档开关彩3;
        ...
        {
            if ((int)db松开高度子项 == 0)
                btn松开高度.Image = global::JSZW1000A.Properties.Resources.btm_4档开关1;
            else if ((int)db松开高度子项 == 1)
                btn松开高度.Image = global::JSZW1000A.Properties.Resources.btm_4档开关2;
            else if ((int)db松开高度子项 == 2)
                btn松开高度.Image = global::JSZW1000A.Properties.Resources.btm_4档开关3;
            else
                btn松开高度.Image = global::JSZW1000A.Properties.Resources.btm_4档开关4;
        ...
        private void 折弯方向显示()
        {
            if ((int)db折弯方向子项 == 0)
            {
                btn折弯方向.Image = global::JSZW1000A.Properties.Resources.btm_单工双工0;
                pnl当前折弯方向.BackgroundImage = global::JSZW1000A.Properties.Resources.BottomApron4;
            }
            else if ((int)db折弯方向子项 == 1)
            {
                btn折弯方向.Image = global::JSZW1000A.Properties.Resources.btm_单工双工1;
                pnl当前折弯方向.BackgroundImage = global::JSZW1000A.Properties.Resources.TopApron4;
            }
        }
        ...
        void redrawPreView(Graphics g1, bool is色下0)
        {
            ...
            //g1.DrawImage((Image)global::JSZW1000A.Properties.Resources.预览背景图0, 0, 0, srcRect, units);

            //绘制背景图
            RectangleF srcRect = new RectangleF(0, 0, 1180, 805);
            GraphicsUnit units = GraphicsUnit.Pixel;
            //g1.DrawImage((Image)global::JSZW1000A.Properties.Resources.预览设备图, 0, 0, srcRect, units);
