...
namespace JSZW1000A.SubWindows
{
    public partial class SubOPLibrary : UserControl
    {
        ...
        private void setLang()
        {
            ...
            btn导入DXF.Text = (MainFrm.Lang == 0) ? " 导入DXF" : "LOAD DXF ";
        }
        ...
        private void btn导入DXF_Click(object sender, EventArgs e)
        {
            ...
            if (openFileDialog.ShowDialog() == DialogResult.OK)
            {
                try
                {
                    ...
                    if (MainFrm.Lang == 0)
                        MessageBox.Show("DXF文件导入成功!" + openFileDialog.FileNames.Length.ToString() + "文件");
                    else
                        MessageBox.Show("DXF File Imported Successfully !" + openFileDialog.FileNames.Length.ToString() + "File");
                }
                catch (Exception ex)
                {
                    if (MainFrm.Lang == 0)
            ...
            if (File.Exists(filePath))
            {
                try
                {
                    ...
                    if (MainFrm.Lang == 0)
                        ...
                        Console.WriteLine("The file has been saved and overwritten with its original content.");
                }
                catch (Exception ex)
                {
                    if (MainFrm.Lang == 0)
            ...
            else // 文件名不重复，直接创建新文件并保存
            {
                try
                {
                    ...
                    if (MainFrm.Lang == 0)
                        ...
                        Console.WriteLine("The new file has been successfully created and saved.");
                ...
                catch (Exception ex)
                {
                    ...
                    if (MainFrm.Lang == 0)
                        ...
                        Console.WriteLine("An error occurred while creating a new file：" + ex.Message);
                }
            }
